...
public class Php extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialogbox = new Dialog(Php.this);
    ...
    protected void onResume() {
        ...
        list2.clear();
        db = new DatabasehelperMain(getApplicationContext());
        db.getWritableDatabase();//db.getreadabledb();
        ArrayList<ProductModule> list21 = db.getProductsphp();
        for (int i = 0; i < list21.size(); i++) {

            String stuid = list21.get(i).getPid();
            String stuname = list21.get(i).getPname();
            String stuamt = list21.get(i).getPamt();
        ...
        textview1.setText("Total Records: " + list2.size());
    ...
    public class Androidview extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            hold.STUDENTID.setText(list2.get(position).getPid());
            hold.STUDENTNAME.setText(list2.get(position).getPname());
            hold.PAIDAMOUNT.setText(list2.get(position).getPamt());
            convertView.setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View v) {
                    // TODO Auto-generated method stub
                    final Dialog dialogbox1 = new Dialog(Php.this);
                    ...
                    updateall.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (updatename1.getText().toString().length() == 0 || updateamt1.getText().toString().length() == 0) {
                                ...
                                pp.pid = (list2.get(position).getPid().toString());
                    ...
                    deleteall.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            // TODO Auto-generated method stub
                            db.RemovePhp(list2.get(position).getPid()
                                    .toString(), null, null);
                            Php.this.onResume();
                            dialogbox1.dismiss();
