...
public class Android extends Activity {
    ...
    ListView listview1;
    TextView textview1;
    private ArrayList<ProductModule> lista = new ArrayList<ProductModule>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialogbox = new Dialog(Android.this);
    ...
    protected void onResume() {
        ...
        db = new DatabasehelperMain(getApplicationContext());
        db.getWritableDatabase();
        ArrayList<ProductModule> lista1 = db.getProductsdroid();
        for (int i = 0; i < lista1.size(); i++) {

            String stuid = lista1.get(i).getPid();
            String stuname = lista1.get(i).getPname();
            String stuamt = lista1.get(i).getPamt();
        ...
        textview1.setText("Total Records: " + lista.size());
    ...
    public class Androidview extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            hold.STUDENTID.setText(lista.get(position).getPid());
            hold.STUDENTNAME.setText(lista.get(position).getPname());
            hold.PAIDAMOUNT.setText(lista.get(position).getPamt());
            convertView.setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View v) {
                    // TODO Auto-generated method stub
                    final Dialog dialogbox1 = new Dialog(Android.this);
                    ...
                    updateall.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (updatename1.getText().toString().length() == 0 || updateamt1.getText().toString().length() == 0) {
                                ...
                                pp.pid = (lista.get(position).getPid().toString());
                    ...
                    deleteall.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            // TODO Auto-generated method stub
                            db.RemoveAndroid(lista.get(position).getPid()
                                    .toString(), null, null);
                            Android.this.onResume();
                            dialogbox1.dismiss();
